...
<style>
    /* Change the background color of the sidebar to green */
    .main-sidebar {
            background-color: #1E5128; /* Green color */
        }

        /* Change the hover color to green */
        .nav-sidebar .nav-link:hover {
            background-color: #D8E9A8; /* Green color */
        }
        #dashboardcss{
            background: red;
        }
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <?php if($_SESSION['login_type'] != 3): ?>
                            <!-- Removed the reference to new_user.php -->
                            <!-- <li class="nav-item">
