<?php
?>
<!-- HTML form for managing user details -->
<div class="col-lg-12">
    <div class="card">
        <div class="card-body">
            <form action="" id="manage_user">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 border-right">
                        ...
                        <!-- User Role selection, visible only to admins -->
                        ...
                        <?php else: ?>
                            <!-- For non-admin users, set the default type to 3 (Employee) -->
                    ...
                    <!-- Right column with additional user information -->
                    <div class="col-md-6">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <!-- Confirm Password input, required for new users -->
...
<script>
    ...
    // Function to display selected avatar image
